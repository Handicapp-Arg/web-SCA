  ...
  const partners = [
    {
      ...
      role: 'role_partner',
      bio: 'ceo_bio',
  image: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_CLOUD_NAME}/image/upload/web-sca/web-sca/profile.webp`,
    ...
    },
    {
      ...
      role: 'role_partner_2',
      bio: 'partner_quote',
  image: `https://res.cloudinary.com/${import.meta.env.VITE_CLOUDINARY_CLOUD_NAME}/image/upload/web-sca/web-sca/Anoushbargh.webp`,
