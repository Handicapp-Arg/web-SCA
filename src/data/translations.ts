...
export const translations: Translations = {
  en: {
    ...
    event_collection: 'New 2026 Collection',
    event_desc_2: 'Let us know you\'re coming so we can have your',
    event_welcome_pack: 'Welcome Pack',
    event_desc_2_end: 'ready and dedicate the time you deserve.',
    nav_factory: 'Factory',
    nav_oem: 'OEM',
    nav_quality: 'Quality',
    nav_bespoke: 'Bespoke',
  ...
  de: {
    ...
    event_collection: 'Neue Kollektion 2026',
    event_desc_2: 'Teilen Sie uns mit, dass Sie kommen, damit wir Ihr',
    event_welcome_pack: 'Willkommenspaket',
    event_desc_2_end: 'vorbereiten und Ihnen die Zeit widmen können, die Sie verdienen.',
    nav_factory: 'Fabrik',
    nav_oem: 'OEM',
    ...
    concept_img_facility_title: 'Modernste Anlage',
    concept_img_facility_desc: 'Moderne Fertigung in Buenos Aires',
    concept_img_craftsmanship: 'Meisterhafte Handwerkskunst',
    concept_img_leather: 'Argentinisches Premium-Leder',
  ...
  es: {
    ...
    event_collection: 'Nueva Colección 2026',
    event_desc_2: 'Avísanos que vendrás para tener listo tu',
    event_welcome_pack: 'Welcome Pack',
    event_desc_2_end: 'y dedicarte el tiempo que mereces.',
    nav_factory: 'Fábrica',
    nav_oem: 'OEM',
    nav_quality: 'Calidad',
    nav_bespoke: 'Bespoke',
